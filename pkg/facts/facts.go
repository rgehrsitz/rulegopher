...
// FactHandler is a struct that contains a reference to an engine.Engine object.
// @property engine - The `engine` property is a pointer to an instance of the `Engine` struct.
type FactHandler struct {
	engine *engine.Engine
}

// NewFactHandler returns a new instance of the FactHandler struct with the provided
// engine.
...
// HandleFact is a method of the `FactHandler` struct. It takes a `fact` of type
